...
const Home = () => {
  ...
  return (
    <div className="landing-container">
      ...
      <button id="get_started_btn" onClick={() => navigate('/login')}>
        Get Started
      </button>
      ...
      <section className="feedback-Carousel">
        ...
        {loading ? (
          ...
          <div className="carousel">
            <div className="carousel-track">
              {feedbacks.map((fb) => (
                <div className="card" key={fb._id}>
                  <img src="/default-user.png" alt={fb.username || "User"} />
      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="footer-links">
            <div className="footer-column">
              <h3>About Us</h3>
              <ul><li><a href="/team">Team</a></li></ul>
            </div>
            <div className="footer-column">
              <h3>Support</h3>
